...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/29 17:39:34 by fzucconi          #+#    #+#             */
/*   Updated: 2024/06/05 15:16:32 by fzucconi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		data_init(char **env, t_data **data);
void		free_data(t_data **data);
void		update_data(char **split_line, t_data **data);
...
int			ft_refactor_wild_arg(
				t_data *data, char **args, int i[3], t_wildcard *w);
